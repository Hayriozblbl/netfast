...
<section id="basic-input">
    ...
    <section id="statistics-card">
      ...
      @foreach ($post->post_images as $post_images)
            ...
            @endforeach
                        ...
                        <script>
                            $(".deleteimage").click(function(){
                                ...
                                $.ajax(
                                {
                                url: "<?php echo url('admin/documents/image') ?>/"+id,
                                type: 'delete',
                                dataType: "JSON",
                                data: {
                                "id": id,
        ...
        <form role="form" action="{{ route('admin.documents.update',$post->id) }}" method="post"
...
@endforeach
            ...
            <div class="box-footer">
                ...
                <a type="button" class="btn btn-warning"
                    href="{{   route('admin.documents.index')   }}">{{ trans('backend.back') }}</a>
            </div>
</form>
