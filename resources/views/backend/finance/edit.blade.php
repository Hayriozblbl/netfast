            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Finans Düzenle</h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                            <form role="form" action="{{ route('admin.finance.update',$finance->id) }}" method="post"
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input id="name" type="text" class="form-control" name="name"
                                                               value="{{ $finance->name }}" aria-required="true"
                                                               required>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="select-basic">
                                                            <select class="form-control" name="amount" id="amount"
                                                                ...
                                                                <option value="10000"
                                                                        @if ($finance->amount == "10000") selected @endif >
                                                                    10000
                                                                </option>
                                                                <option value="20000"
                                                                        @if ($finance->amount == "20000") selected @endif >
                                                                    20000
                                                                </option>
                                                                <option value="30000"
                                                                        @if ($finance->amount == "30000") selected @endif >
                                                                    30000
                                                                </option>
                                                                <option value="40000"
                                                                        @if ($finance->amount == "40000") selected @endif >
                                                                    40000
                                                                </option>
                                                                <option value="50000"
                                                                        @if ($finance->amount == "50000") selected @endif >
                                                                    50000
                                                                </option>
                                                            </select>
                                                        </div>
