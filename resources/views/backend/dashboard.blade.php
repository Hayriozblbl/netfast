    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-sm-6 col-12">
            <div class="card">
                <div class="card-header d-flex align-items-start pb-0">
                    <div>
                        <a href="{{ route('admin.auth.user.deactivated') }}">
                            <h2 class="text-bold-700 mb-0">{{ $pending_approval }}</h2>
                            <p>@lang('backend.pending_approval')</p>
                        </a>
                    </div>
        ...
        <div class="col-lg-3 col-sm-6 col-12">
            <div class="card">
                <div class="card-header d-flex align-items-start pb-0">
                    <div>
                        <a href="{{ route('admin.auth.user.deleted') }}">
                            <h2 class="text-bold-700 mb-0">{{ $deleted_users }}</h2>
                            <p>@lang('menus.backend.access.users.deleted')</p>
                        </a>
                    </div>
        ...
        <div class="col-lg-3 col-sm-6 col-12">
            <div class="card">
                <div class="card-header d-flex align-items-start pb-0">
                    <div>
                        <a href="{{URL('about/board-of-directors')}}">
                            <h2 class="text-bold-700 mb-0">{{ $boards}}</h2>
                            <p>{{ trans('frontend.board_of_directors') }}</p>
                        </a>
                    </div>
                ...
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <a href="{{ route('admin.post.index') }}">
                            ...
                            <p class="mb-0 line-ellipsis">{{ trans('backend.posts') }}</p>
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <a href="{{ route('admin.activity.index') }}">
                            <h2 class="text-bold-700">{{ $activities}}</h2>
                            <p class="mb-0 line-ellipsis">{{ trans('frontend.activities') }}</p>
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <a href="{{ route('admin.testimonial.index') }}">
                            <h2 class="text-bold-700">{{ $testimonials}}</h2>
                            <p class="mb-0 line-ellipsis">{{ trans('backend.testimonials') }}</p>
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <a href="{{ route('admin.contact_forms.index') }}">
                            <h2 class="text-bold-700">{{ $contact_forms }}</h2>
                            <p class="mb-0 line-ellipsis">{{ trans('backend.contacts_forms') }}</p>
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <a href="{{ route('admin.team.index') }}">
                            <h2 class="text-bold-700">{{ $teams}}</h2>
                            <p class="mb-0 line-ellipsis">{{ trans('backend.team') }}</p>
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="card text-center">
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <a href="{{ route('admin.activitytype.index') }}">
                            <h2 class="text-bold-700">{{ $activitytypes }}</h2>
                            <p class="mb-0 line-ellipsis">{{ trans('backend.activitytype') }}</p>
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="card text-center">
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <a href="{{ route('admin.unittype.index') }}">
                            <h2 class="text-bold-700">{{ $unittypes }}</h2>
                            <p class="mb-0 line-ellipsis">{{ trans('backend.unittype') }}</p>
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <a href="{{ route('admin.sector.index') }}">
                            <h2 class="text-bold-700">{{ $sectors }}</h2>
                            <p class="mb-0 line-ellipsis">{{ trans('backend.sectors') }}</p>
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <a href="{{ route('admin.field.index') }}">
                            <h2 class="text-bold-700">{{ $fields}}</h2>
                            <p class="mb-0 line-ellipsis">{{ trans('backend.fields') }}</p>
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="card text-center">
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <a href="{{ URL('/admin/forum/category')}}">
                            <h2 class="text-bold-700">{{ $forum_categories }}</h2>
                            <p class="mb-0 line-ellipsis">{{ trans('backend.forum_category') }}</p>
                        </a>
                    </div>
                </div>
            </div>
